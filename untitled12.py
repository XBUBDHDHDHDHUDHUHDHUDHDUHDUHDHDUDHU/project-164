...
def PlanetInfo():
    ...
    if planet == "Mercury":
     ...
     label_planet_info['text'] = "Venus is the brightist object in the sky after the sun and the Moon, and sometimes looks like a bright star in the morning or evening sky"

    elif planet == "Earth":
     label_planet_name['text'] = "Earth"
     label_planet_image['image'] = Earth
     label_planet_gravity_radius['text'] = "Gravity : 9.807 m|s \n Radius : 6,371 km"
     label_planet_info['text'] = "Earth is the only place in this known universe confirmed to host life and its the only known one for sure to have liquid water on its surface."
